...
|Ильин Александр         |  9  | +++ |  +  | +   |  +- |  +- |  +-  |  ?  |    |    |   8  |            |
|Ковалевский Глеб        |  7  | +++ |   + |  +  |  -  |  ++-|  +   |  Н  |    |    |   7  |            |
|Кисляков Владислав      |  8  | +++ |  +  |  +  |  +  |  -+ |   +  |  ?  |    |    |   8  | после 2пинков |
|Куделич Дмитрий         |  8  | +++ |  -+ |  +- |  +  |  +  |   +  |     |    |    |   7  |   1-2 у кого-то я этот код уже видел....  |
|Мальчикова Ксения       |  8  | -+- |  +  |  -  |  +  | +-  |   +  |     |    |    |   6  |            |
|Мартиневский Денис      |  10 |  +  |  +  |  +  |  -  |  -  |   +- |     |    |    |   8  |            |
|Марченко Иван           |  6  | -++ | +-  |  -+ |  -  | --+ |   -+ |     |    |    |   5  |            |
|Петращенко Артем        |  5  | --- | -+  |   + |  --+|  -+ |   +  |     |    |    |   5  |            |
|Рапинчук Лиза           |  8  |  +++|  +  |  +  |  -  |  +- |   +  |     |    |    |   7  |            |
|Сорока Диана            |  6  |  ?  |  ?  |  ?  |  ?  |  ?  |      |     |    |    |      |            |
|Тухолко Алексей         |  7  | +++ |  +  |  +  |  +- |  +- | +    |  •  |    |    |   7  |bmp(Гапанович) |
|Хомцов Антон            |  7  | --+ |  -  |  +? |  -  |  +  |  +-  |     |    |    |   5  |            |
|Шпаковский Андрей       |  7  | ++- | -+  |  +  |  -  |  +? |   +- |     |    |    |   5  |bmp(Жилко)  |
