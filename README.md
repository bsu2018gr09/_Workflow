...
## Задание на 29.03 (чтение файла bmp)
...
2. Найти в сети в каких байтах записаны высота и ширина. Найти их в вашем файле. Убедиться, что там записано 256px и 128px     
3. Написать свою программ, уоторая читает эти данные из bmp файла
